...
function modifyBoard($board_id, &$boardOptions)
{
	...
	{
		$boardUpdates[] = 'img_filename = {string:img_filename}';
		$boardUpdateParameters['img_filename'] = $boardOptions['img_filename'];
	}
	if (isset($boardOptions['img_link']))
	{
		$boardUpdates[] = 'img_link = {string:img_link}';
		$boardUpdateParameters['img_link'] = $boardOptions['img_link'];
	}
