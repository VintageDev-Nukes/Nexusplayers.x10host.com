...
//      Archivó de lenguaje de la tienda
...
$txt['shop_settings_currency'] = "Próxima Configuración";
...
$txt['shop_transfer_success'] = "Objeto transferido con éxito!";
...
$txt['shop_version_info_header'] = "versión de la Información";
$txt['shop_version_number'] = "Numero de la versión";
...
$txt['shop_back2admin'] = "Atrás a {$txt['shop_admin']}";
$txt['shop_back2bank'] = "Atrás al {$txt['shop_bank']}";
$txt['shop_back2inv'] = "Atrás a tu {$txt['shop_inventory']}";
$txt['shop_bankinterest'] = "{$txt['shop_bank']} {$txt['shop_interest']}";
$txt['shop_bank_minDeposit'] = "Mínimo {$txt['shop_bank_deposit']}";
$txt['shop_bank_minWithdraw'] = "Mínimo {$txt['shop_bank_withdraw']}";
$txt['shop_bank_welcome'] = "¡Bienvenido al {$txt['shop_bank']} de la {$txt['shop']}!";
...
$txt['shop_trade_welcome'] = "¡Bienvenido al {$txt['shop']} {$txt['shop_trade']}!";
$txt['shop_welcome'] = "¡Bienvenido a la {$txt['shop']}!";
...
$txt['shop_bank_welcome_full'] = "{$txt['shop_bank_welcome']} Aquí, puedes almacenar con seguridad tus créditos y ganar el interés para ellos!";
$txt['shop_bank_disableMin'] = " Para permitir que el usuario deposite o retire cualquier cantidad, introducir por favor â0â como el mínimo ";
$txt['shop_bought_item'] = " Compraste con éxito un '%s'. Para usarlo, click en el '{$txt['shop_yourinv']}' link de la derecha.";
...
$txt['shop_dont_have_much2'] = "ERROR: ¡No tienes tanto dinero en el {$txt['shop_bank']}!";
$txt['shop_edit_message'] = "Abajo parecen el listado de objetos en tu {$txt['shop']}. Para editar, presiona '{$txt['shop_edit']}' link al lado. Para borrar objeto, click en la caja al lado del objeto, y presiona el '{$txt['shop_delete']}' botón en el fondo de la pagina.";
...
$txt['shop_membergroup_desc'] = "Aquí, puede agregar o quitar dinero de los miembros, dependiendo del grupo en el que se encuentren. Por favor llena los campos y presiona  '{$txt['shop_next']}' el boton.";
...
$txt['shop_send_items_message'] = "Puedes dar un objeto a alguien, sin que ellos tengan que pagar el. Si desea vender el objeto, Por favor utilizar el centro comercial. Nota ningun objeto que se encuentre en el centro comercial no se enumerado aquí.";
...
$txt['shop_use_others_item'] = "¿Qué estás haciendo? ¡¡¡Esto NO es tuyo!!! Para de robar, en SMFShop es mas elegante ;)";
$txt['shop_use_others_item2'] = "¿Qué estás haciendo? ¡¡¡Esto NO es tuyo!!! And you even went to inv3!! Bien, puede ser que intentes otra vezâ¦ Para de robar, en SMFShop es mas elegante ;)";
$txt['shop_wanna_trade'] = "¿Desear negociar tus objetos? Haz click '{$txt['shop_yourinv']}'en el lado izquierdo de la pantalla, y click '{$txt['shop_tradeitem']}' link en el siguiente objeto. El objeto aparecera aquí, y los usuarios podran comprar tu objeto. Recibiaras una notificacion cuando alguien compre tu objeto.";
$txt['shop_welcome_full'] = "¡Bienvenido a la {$txt['shop']}! Aquí puede 'comprar' objetos con los creditos que ha conseguido por participar en el foro.";
