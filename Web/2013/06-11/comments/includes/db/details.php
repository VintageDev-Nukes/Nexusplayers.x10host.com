...
$cmtx_mysql_database = 'nexuspla_yers';				// The name of the database you created
$cmtx_mysql_username = 'nexuspla_nukes'; 				// Your MySQL username
$cmtx_mysql_password = '23333300FF';			 	// Your MySQL password
