...
$txt['shop_bank_minDeposit'] = "MÃ­nimo {$txt['shop_bank_deposit']}";
$txt['shop_bank_minWithdraw'] = "MÃ­nimo {$txt['shop_bank_withdraw']}";
...
$txt['shop_bank_welcome_full'] = "{$txt['shop_bank_welcome']} AquÃ­, puedes almacenar con seguridad tus cr&eacute;ditos y ganar el inter&eacute;s para ellos!";
$txt['shop_bank_disableMin'] = " Para permitir que el usuario deposite o retire cualquier cantidad, introducir por favor â0â como el mÃ­nimo ";
...
$txt['shop_use_others_item'] = "&iquest;Qu&eacute; est&aacute;s haciendo? esto NO es tuyo!!! Para de robar, en SMFShop es mas elegante ;)";
$txt['shop_use_others_item2'] = "&iquest;Qu&eacute; est&aacute;s haciendo? esto NO es tuyo!!! And you even went to inv3!! Bien, puede ser que intentes otra vezâ¦ Para de robar, en SMFShop es mas elegante ;)";
$txt['shop_wanna_trade'] = "&iquest;Desear negociar tus objetos? Haz click '{$txt['shop_yourinv']}'en el lado izquierdo de la pantalla, y click '{$txt['shop_tradeitem']}' link en el siguiente objeto. El objeto aparecera aqui, y los usuarios podran comprar tu objeto. Recibiaras una notificacion cuando alguien compre tu objeto.";
$txt['shop_welcome_full'] = "Bienvenido {$txt['shop']}! Aca, puede 'comprar' objetos con los creditos que ha conseguido por participar en el foro!";
